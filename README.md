...
|---|---|---|
| [dev-pair](dev-pair/) | 1.1.5 | Second-opinion code review / critique from a *different* LLM than the one doing the work — supervisory pair-programming across model families. **User-invoked only**; you choose the reviewing model |
